"""
Run this from LibraryPro\backend\ to fully rewrite app.py correctly.
  python patch.py
"""
APP = '''"""
LibraryPro - Flask Backend (Fixed for Windows + mysql-connector-python)
...
with open("app.py", "w", encoding="utf-8") as f:
    f.write(APP)
print("✅ app.py fully rewritten! Now run: python app.py")
